	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
	  <div class="container-fluid">
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="">SIAL 
		  <?php	if(!empty($_SESSION[USUARIO])) echo " - ".$_SESSION[USUARIO];	?></a>
		...
		<div id="navbar" class="navbar-collapse collapse">          
		  <ul class="nav navbar-nav navbar-right">
			...
			if(empty($_SESSION[USUARIO])){
			  echo '<li><a href="?page=sesion">Admin</a></li>';
			}else{
	...
	<div class="container-fluid">
	  <div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
		  ...
		  <ul class="nav nav-sidebar">
			<li <?php echo ($page=="producto")?"class=\"active\"":""; ?> ><a href="?page=producto">Maestro de Producto</a></li>
			<li <?php echo ($page=="kardex")?"class=\"active\"":""; ?> ><a href="?page=kardex">Kardex Productos</a></li>
		  </ul>
		  <ul class="nav nav-sidebar">
